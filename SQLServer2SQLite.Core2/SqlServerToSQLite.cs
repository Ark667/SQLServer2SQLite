...
namespace DbAccess
{
    ...
    public class SqlServerToSQLite
    {
            ...
            bool createTriggers, bool createViews)
        {
            ...
            CreateSQLiteDatabase(sqlitePath, ds, password, createViews);
        ...
        private static SqliteCommand BuildSQLiteInsert(TableSchema ts)
        {
            ...
            for (int i = 0; i < ts.Columns.Count; i++)
            {
                ...
                SqliteParameter prm = new SqliteParameter(pname, dbType, 1, ts.Columns[i].ColumnName);
        ...
        private static void ValidateDataType(string dataType)
        {
            if (dataType == "int" || dataType == "smallint" ||
                ...
                dataType == "decimal" || dataType == "nchar" || dataType == "datetime" || dataType == "datetimeoffset")
                return;
        ...
        private static ILog _log = new FileLogger();
    }
